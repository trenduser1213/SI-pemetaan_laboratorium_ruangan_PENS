        ...
        <div class="table-responsive-lg scroll">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="includes/materi.php"><?php $_POST['nomor']=$Materi['NOMOR'] ?>
                        <input type="text" id="updateJudulcoba" class="form-control" required name="updateJudulcoba" value="<?php echo $judul?>">
                ...
                <div class="modal fade" id="edit<?php //echo $idMateri;?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            ...
                            <form action="includes/materi.php" method="POST">
