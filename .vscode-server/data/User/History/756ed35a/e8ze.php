...
$cekRulesKepalaRuang = RulesKepalaRuang($idRuang, $idAnggota);
var_dump($cekRulesKepalaRuang);
$cekRulesAsistenRuang = RulesAsistenRuang($idRuang, $idAnggota);
var_dump($cekRulesAsistenRuang);
$cekRulesTeknisiRuang = RulesTeknisiRuang($idRuang, $idAnggota);
