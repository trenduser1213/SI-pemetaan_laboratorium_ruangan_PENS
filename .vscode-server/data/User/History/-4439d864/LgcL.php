...
if(isset($_POST['kirimPenelitian'])){
    ...
    $dosbim1 = $_POST['dosbim1'];
    $dosbim2 = $_POST['dosbim2'];
    $dosbim3 = $_POST['dosbim3'];
    ...
    $hasil = createPenelitian($judulPenelitian, $idRuang, $idPeneliti, $idDosbim1, $idDosbim2, $idDosbim3);
    var_dump($hasil);
}
?>
