                                        ...
                                        if(sizeof($rowss) == 0){
                                            ...
                                            foreach ($rowss as $hasill) {
                                                if($hasill['KEANGGOTAAN'] == 1){
                                                    ...
                                                    echo '<button name="leave" class="btn btn-warning btn-icon-split" role="button"><span class="text-white-50 icon"><i class="fas fa-flag"></i></span><span class="text-white text">with</span></button></form>
                                                }
