                                                ...
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php $nomorID = $anggotaLab['NOMOR']; ?>
                                                            <td>Mahasiswa</td>
                                                            <?php 
                                                            if($anggotaLab['KEANGGOTAAN'] == "1"){
                                                                ?>
                                                                <td><button class="btn btn-success">terima</button></td>
                                                                <td><button class="btn btn-warning">tolak</button></td>
                                                            <?php 
                                                            }else{
                                                                ?>
                                                            <td><button class="btn btn-danger">keluarkan</button></td>
                                                            <?php } ?> 
                                                        </tr>
                                                        <?php
                                                        $noAnggota++;
