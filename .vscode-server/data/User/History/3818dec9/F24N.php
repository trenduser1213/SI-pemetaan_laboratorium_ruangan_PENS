        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="rAdmin.html"><i class="fa fa-money"></i><span>Ruang Administrasi dan lain</span></a></li>
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="card shadow mb-4">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h6 class="text-primary font-weight-bold m-0">Ruang Administrasi dan Lainya</h6>
                                    <div class="pb-0 pt-2">
                                        <div class="align-items-center form-row">
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody class="">
                                            ...
                                            <tr>
                                            <th scope="row">2</th>
                                            <td><a href="#">Ruang Kaprodi</a></td>
                                                <td>C 101</td>
                                            <td>Gedung D3</td>
                                            </tr>
                                            <tr>
                                            <th scope="row">3</th>
                                            <td><a href="#">Ruang Direktur</a></td>
                                                <td>C 101</td>
                                            <td>Gedung D3</td>
                                            </tr>
                                            <tr>
