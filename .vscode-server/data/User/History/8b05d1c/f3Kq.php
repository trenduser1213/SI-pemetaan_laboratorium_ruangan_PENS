                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            ?>
                                                    ...
                                                    <?php echo $isi['ISI']; 
                                                    $nomor = $isi['NOMOR'];?>
                                                    <button class="btn btn-primary rounded-pill fa fa-gear" name="deletePengumuman"  data-bs-toggle="modal" data-bs-target="#gearPengumuman"></button>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="" method="POST">
                                                                    <div class="modal-body">
                                                                        <button type="button" class="btn btn-secondary" name="modal">Close</button>
                                                                        <form action="" method="POST"><button type="submit" class="btn btn-danger fa fa-trash" name="deletePengumuman">DELETE</button></form>
                                                                    </div>
                                                                </form>
                                                            </div>
                                                        </div>
