...
<body class="bg-gradient-primary"><div class="svg-container">
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/Tempclipboard-image.png&quot;);"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Sistem Informasi Pemetaan Laboratorium Dan Ruangan Ruang Lingkup PENS&nbsp;</h4>
                                    </div>
                                    <form class="user" method="post" action="<?php echo $_SERVER['REQUEST_URL'] ?>">
