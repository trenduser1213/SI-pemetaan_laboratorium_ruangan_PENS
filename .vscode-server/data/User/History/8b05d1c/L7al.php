                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            ?>
                                                    ...
                                                    <?php echo $isi['ISI']; 
                                                    $nomor = $isi['NOMOR'];?>
                                                    <button class="btn btn-primary rounded-pill fa fa-gear" name="" data-bs-toggle="modal" data-bs-target="#gearPengumuman<?php echo $isi['NOMOR'];?>"></button>
                                                    <br>
                                                    
                                                    <?php $no++;} ?>
                                                    <!-- modal button edit pengumuman -->
                                                    <div class="modal fade" id="gearPengumuman<?php echo $isi['NOMOR'];?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="" method="POST">
                                                                    <div class="modal-body">
                                                                        <button type="button" class="btn btn-warning" name="modal"  data-bs-toggle="modal" data-bs-target="#editPengumuman<?php// echo $isi['NOMOR'];?>">Edit</button>
                                                                        <form action="" method="POST">
                                                    ...
                                                    <div class="modal fade" id="eeditPengumuman<?php// echo $isi['NOMOR'];?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
