...
function konfirmasi($idRuang, $idAnggota, $nomor, $status) {
    $db_user = "pa0021";
    $db_pass = "375300";
    $con = konekDb($db_user, $db_pass);
    $sql = "UPDATE ANGGOTALAB SET STATUSANGGOTA = $status WHERE RUANG = $idRuang AND ANGGOTA = $idAnggota AND NOMOR = $nomor";
