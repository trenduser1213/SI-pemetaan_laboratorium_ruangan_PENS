            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button name="" class="btn btn-primary fa fa-gear rounded-pill" data-bs-toggle="modal" data-bs-target="#gearPeneliti"></button>
                        </td>
                        <!-- <td>
                            <form method="POST" >
                    ...
                    <div class="modal fade" id="gearPeneliti" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <form action="" method="POST">
                                    <div class="modal-body">
                                        <button type="button" class="btn btn-warning" name="modal"  data-bs-toggle="modal" data-bs-target="#editPenelitian">Edit</button>
                                        <form method="POST" >
                                            <input type="hidden" name="id_Penelitian" value="<?php echo $DataPenelitian['NOMOR']?>">
                                            <button name="deletePenelitan" class="btn btn-danger fa fa-trash">delete</button>
                                        </form>
                    ...
                    <div class="modal fade" id="editPenelitian" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
