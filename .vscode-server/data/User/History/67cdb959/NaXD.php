                                            ...
                                            <div class="card-body">
                                                ...
                                                ?>
                                                   ...
                                                   <tbody>
                                                       <?php
                                                       $noAnggota = 1;
                                                       $anggotaPegawai = PegawaiPerRuang($idRuang);
                                                       ...
                                                       ?>
                                                       <?php
                                                       $anggotaMahasiswa = MahasiswaPerRuang($idRuang);
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            if($anggota['KEANGGOTAAN'] == '1'){
                                                                ?>
                                                                <form method="POST">
                                                                    <input type="hidden" name="nomor" value="<?php echo $anggota['NOMOR']?>">
                                                                    <input type="hidden" name="anggota" value="<?php echo $anggota['ANGGOTA']?>">        
                                                                    <td><button name="terima" class="btn btn-success">terima</button></td>
                                                                    <td><button name="delete" class="btn btn-warning">tolak</button></td>
                                                                </form>
                                                            <?php 
                                                            }else{
                                                                ?>
                                                            <td colspan="2">
                                                                <form method="POST">
                                                                    <input type="hidden" name="id_anggotaLab" value="<?php echo $anggota['NOMOR']?>">
                                                                    <button name="delete" class="btn btn-danger">keluarkan</button>
                                                                </form>
                                                            </td>
                                                            <?php } ?>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            if($anggotaLab['KEANGGOTAAN'] == "1"){
                                                                ?>
                                                                <form method="POST">
                                                                    <input type="hidden" name="nomor" value="<?php echo $anggotaLab['NOMOR']?>">
                                                                    <input type="hidden" name="anggota" value="<?php echo $anggotaLab['ANGGOTA']?>">
                                                                    <td><button name="terima" class="btn btn-success">terima</button></td>
                                                                    <td><button name="delete" class="btn btn-warning">tolak</button></td>
                                                                </form>
                                                            <?php 
