...
<body id="page-top">
    ...
    <div class="btn btn-primary text-light pl-4 pr-4 mb-2 rounded-pill">
    ...
    <table class="table table-hover">
        ...
        <tbody class="">
            <tr>
              ...
              <td>@mdo</td>
                <td>7</td>
                <td><div class="btn btn-warning text-light">edit</div>
                </td>
                <td><div class="btn btn-primary text-light">delete</div></td>
            </tr>
            <tr>
              <th scope="row">2</th>
              <td>Jacob</td>
            ...
            <tr>
              ...
              <td>Larry the Bird</td>
                <td>Thornton</td>
              <td>@twitter</td>
                <td>7</td><td><div class="btn btn-warning text-light">edit</div>
                </td>
                <td><div class="btn btn-primary text-light">delete</div></td>
            </tr>
            <tr>
