...
<head>
    ...
    <script src="assets/js/bootstrap." integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
</head>
                          ...
                          if(isset($_GET['halaman'])){
                            if($_GET['halaman'] == 'lab'){
                              ...
                              include 'rKuliah.php';
                                ...
                                include 'rAdmin.php';
                            }elseif ($_GET['halaman'] == 'detailRuang') {
